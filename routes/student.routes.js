...
router.route('/profile').get(protect, authorizeRoles('Student'), getMyProfile)
...
router
  .route('/:id/qrcode')
  .get(protect, authorizeRoles('Admin', 'Teacher', 'Student'), getStudentQrCode) // Student can get their own QR code
